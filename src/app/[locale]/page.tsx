  ...
  return (
    <div className="min-h-screen bg-[#030712] text-white font-sans overflow-x-hidden selection:bg-blue-500/30">
      ...
      <nav className="sticky top-0 z-[100] bg-[#030712]/80 backdrop-blur-xl border-b border-white/5">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-10">
            <Link href="/" className="text-[13px] font-black uppercase tracking-widest text-white/50 hover:text-white transition-all">Anasayfa</Link>
            <Link href="#features" className="text-[13px] font-black uppercase tracking-widest text-white/50 hover:text-white transition-all">Yetenekler</Link>
            <Link href="#workflow" className="text-[13px] font-black uppercase tracking-widest text-white/50 hover:text-white transition-all">Nasıl Çalışır?</Link>
            <Link href="#pricing" className="text-[13px] font-black uppercase tracking-widest text-white/50 hover:text-white transition-all">Fiyatlandırma</Link>
            <Link href="/tr/blogs" className="text-[13px] font-black uppercase tracking-widest text-white/50 hover:text-white transition-all">Haberler</Link>
          </div>

          <div className="hidden lg:flex items-center gap-4">
            <Link href="/tr/login" className="px-6 py-2.5 bg-white/5 text-white/70 rounded-xl border border-white/10 text-xs font-black uppercase tracking-widest hover:bg-white/10 transition-all">Giriş Yap</Link>
            <Link href="/tr/login" className="px-7 py-3 bg-blue-600 text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-blue-500 shadow-xl shadow-blue-600/20 active:scale-95 transition-all">Ücretsiz Başla</Link>
          </div>
      ...
      <section className="relative pt-20 pb-20 lg:pt-40 lg:pb-32 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1400px] h-[800px] bg-blue-600/10 blur-[130px] rounded-full opacity-30 pointer-events-none" />
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-gray-400 text-lg lg:text-xl max-w-2xl mx-auto mb-16 leading-relaxed font-medium">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <Link href="#features" className="group w-full sm:w-auto px-12 py-6 bg-white/5 border border-white/10 rounded-[2rem] text-lg font-black flex items-center justify-center gap-3 hover:bg-white/10 transition-all">
              Sistemi Keşfet
            </Link>
          </div>
        </div>
      ...
      <section id="features" className="py-32 relative">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-24">
            <h2 className="text-4xl lg:text-6xl font-black mb-8 leading-tight tracking-tighter">İş Akışınızı Sıfır Hata ile Dijitalleştirin</h2>
      ...
      <section id="workflow" className="py-32 bg-white/5 border-y border-white/5 overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="text-center mb-24">
            <h2 className="text-4xl lg:text-6xl font-black mb-6 tracking-tighter text-balance">Nasıl Çalışır?</h2>
      ...
      <section id="pricing" className="py-32 relative">
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-24">
            <h2 className="text-4xl lg:text-6xl font-black mb-6 tracking-tighter">Esnek Fiyatlandırma</h2>
      ...
      <section className="py-24 bg-white/[0.02]">
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            <Quote className="w-16 h-16 text-blue-600/30 mx-auto mb-12" />
            <p className="text-2xl lg:text-4xl font-bold italic leading-relaxed mb-12">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="text-left">
                <p className="font-black text-xl">Ahmet Yılmaz</p>
      ...
      <section className="py-32">
        <div className="container mx-auto px-6 max-w-4xl">
          <h2 className="text-4xl lg:text-5xl font-black mb-16 text-center tracking-tighter">Sıkça Sorulan Sorular</h2>
      ...
      {/* Blogs Section */}
      <section id="blogs" className="py-32 bg-white/5 border-t border-white/5">
        <div className="container mx-auto px-6">
          <div className="flex items-end justify-between mb-16 gap-4">
            <div>
              <h2 className="text-4xl lg:text-5xl font-black mb-4 tracking-tighter">Haberler & Analizler</h2>
              <p className="text-gray-400 font-medium">Sektördeki teknolojik gelişmeleri takip edin.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogs.map((blog, idx) => (
              <Link key={idx} href={`/tr/blog/${blog.slug}`} className="group bg-[#0a0f1d] border border-white/5 rounded-[2.5rem] overflow-hidden hover:border-blue-500/20 transition-all flex flex-col h-full shadow-2xl">
                <div className="h-56 bg-gray-800 overflow-hidden relative">
                  {blog.image ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <FileSearch className="w-12 h-12 text-white/10" />
                    </div>
                  )}
                </div>
                <div className="p-8 flex flex-col flex-1">
                  <h4 className="text-xl font-bold mb-4 group-hover:text-blue-400 transition-colors">{blog.title}</h4>
                  <p className="text-gray-400 text-sm mb-8 leading-relaxed line-clamp-2">{blog.excerpt}</p>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="max-w-4xl mx-auto space-y-10">
            <h2 className="text-5xl lg:text-7xl font-black tracking-tighter">Dijital Dönüşüm İçin Beklemeyin.</h2>
            <p className="text-gray-400 text-xl font-medium">Hemen ücretsiz üyeliğinizi oluşturun ve 5 kredinizle ilk analizlerinizi yapın.</p>
            <div className="pt-10 flex flex-col sm:flex-row items-center justify-center gap-8">
              <Link href="/tr/login" className="px-16 py-7 bg-white text-black text-xl font-black rounded-[2.5rem] hover:scale-105 transition-all shadow-2xl active:scale-95">
                Hesabını Oluştur
              </Link>
              <p className="text-gray-600 font-black text-xs uppercase tracking-[0.3em]">KREDİ KARTI GEREKMEZ</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="pt-24 pb-12 bg-[#020617] relative border-t border-white/5">
        <div className="container mx-auto px-6">
...
function FeatureCard({ icon, title, desc }: any) {
  return (
    <div className="p-10 bg-white/[0.03] border border-white/5 rounded-[3rem] hover:bg-white/[0.06] hover:border-blue-500/20 hover:-translate-y-2 transition-all duration-300 group">
      <div className="w-16 h-16 bg-white/[0.05] rounded-2xl flex items-center justify-center mb-8 border border-white/5 group-hover:scale-110 group-hover:bg-blue-600/10 transition-transform">
        {icon}
      </div>
...
function WorkflowStep({ number, title, desc, icon }: any) {
  return (
    <div className="relative z-10 text-center space-y-6">
      <div className="w-20 h-20 bg-[#0a0f1d] border-2 border-white/5 rounded-[2rem] flex items-center justify-center mx-auto relative group hover:border-blue-500 transition-colors">
        <div className="absolute -top-4 -left-4 w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-xs font-black shadow-lg shadow-blue-600/20">{number}</div>
        {icon}
      </div>
      <h4 className="text-2xl font-black">{title}</h4>
      <p className="text-gray-500 font-medium leading-relaxed px-4">{desc}</p>
    </div>
  );
}
...
function PriceCard({ title, price, credits, features, cta, highlight, onClick }: any) {
  return (
    <div className={`p-10 lg:p-12 rounded-[3.5rem] border ${highlight ? 'bg-blue-600 border-blue-500 scale-105 shadow-[0_30px_60px_-15px_rgba(59,130,246,0.3)]' : 'bg-white/[0.03] border-white/5'} flex flex-col relative`}>
      ...
      <h3 className={`text-xl font-black mb-1 ${highlight ? 'text-blue-100' : 'text-gray-400'}`}>{title}</h3>
      <div className="flex items-baseline gap-2 mb-8">
        <span className="text-4xl font-black">{price}</span>
        {price !== 'Özel' && price !== 'Ücretsiz' && <span className="text-xs font-bold opacity-50">/Paket</span>}
      </div>
      <div className={`p-6 rounded-3xl mb-10 ${highlight ? 'bg-white/10' : 'bg-white/5'}`}>
        <p className="text-xs font-black tracking-widest uppercase mb-1 opacity-50">KREDİ</p>
        <p className="text-2xl font-black">{credits}</p>
      </div>
      <ul className="space-y-5 mb-12 flex-1">
        {features.map((f: string, i: number) => (
          <li key={i} className="flex items-center gap-3 text-sm font-bold">
            <Check className={`w-5 h-5 ${highlight ? 'text-white' : 'text-blue-500'}`} />
            <span className={highlight ? 'text-white/90' : 'text-gray-400'}>{f}</span>
          </li>
        ))}
      </ul>
      <button
